    ...
    <HomeContainer>
      ...
      <FeaturesSection ref={featuresRef} className="hover:cursor-pointer">
        <FeatureCard>
          ...
          <FeatureDescription>
            spelling, punctuation and sentence structure ko smart suggestions
            ke saath sudharo
          </FeatureDescription>
        </FeatureCard>
        <FeatureCard>
          ...
          <FeatureDescription>
            same sentence ko alag alag styles me likho, jaise formal, casual and
            creative
          </FeatureDescription>
        </FeatureCard>
        <FeatureCard>
          ...
          <FeatureDescription>
            direct mobile and PC keyboard se grammar aur sentence improvements
            karo
          </FeatureDescription>
        </FeatureCard>
      </FeaturesSection>
